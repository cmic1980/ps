...
public class ParameterStorePropertySourceEnvironmentPostProcessor implements EnvironmentPostProcessor
{
    ...
    static final String PARAMETER_STORE_ACCEPTED_PROFILE = "ctx.config.aws.ps.enabled";

    static final String PARAMETER_STORE_ACCEPTED_PROFILES_CONFIGURATION_PROPERTY = "ctx.config.aws.ps.enabledProfiles";
    static final String PARAMETER_STORE_ENABLED_CONFIGURATION_PROPERTY = "ctx.config.aws.ps.enabled";
    static final String PARAMETER_STORE_HALT_BOOT_CONFIGURATION_PROPERTY = "ctx.config.aws.ps.haltBoot";
    static final String PARAMETER_STORE_CLIENT_ENDPOINT_CONFIGURATION_PROPERTY = "ctx.config.aws.ps.ssmClient.endpointConfiguration.endpoint";
    static final String PARAMETER_STORE_CLIENT_ENDPOINT_SIGNING_REGION_CONFIGURATION_PROPERTY = "ctx.config.aws.ps.ssmClient.endpointConfiguration.signingRegion";
